...
public partial class Home : System.Web.UI.Page
{
    ...
    {        
        if (interestedStocks != null && interestedStocks.Length > 0)
        {
            ...
            upVotesVSdownVotesCell.Controls.Add(new LiteralControl(gui.BoldFontStart + "Number of Recommendations " + "[" + gui.GreenFontStart + "Up" + gui.GreenFontEnd + "|" + gui.RedFontStart + "Down" + gui.RedFontEnd + "]" + gui.BoldFontEnd));
            currentUserPredictedValueCell.Controls.Add(new LiteralControl(gui.BoldFontStart + "What Users Recommend" + gui.BoldFontEnd));
            ...
            //  predictionCell.Controls.Add(new LiteralControl(gui.BoldFontStart + "Click to Predict" + gui.BoldFontEnd));
